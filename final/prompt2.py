    ...
    while(original_path_no_start != [[],[],[],[],[],[]]):#需要修改
        for i in range(6):
            if original_path_no_start[i] != []:#需要修改
                ...
                # print('new_occupied_matrix 4:', new_occupied_matrix[4])
                # print('original_path 4:', original_path[4])
...
if __name__ == '__main__':
    ...
    # original_path,original_path_no_start = original_path(map_size, obstacle, agent_start, agent_goal)
    # robot_position = final_path(agent_start, agent_goal, original_path, original_path_no_start)
    # robot_position.append([[5, 0], [5, 1], [5, 2], [3, 7], [4, 8], [4, 9]])
    # robot_position.append([[5, 0], [5, 1], [5, 2], [3, 7], [4, 8], [4, 10]])
    # robot_position.append([[5, 0], [5, 1], [5, 2], [3, 8], [4, 8], [4, 10]])
    # robot_position.append([[5, 0], [5, 1], [5, 2], [3, 8], [4, 9], [5, 10]])
    # robot_position.append([[5, 0], [5, 1], [5, 2], [4, 8], [4, 9], [5, 10]])
    # robot_position.append([[5, 0], [5, 1], [5, 2], [4, 8], [5, 9], [5, 10]])
    # robot_position.append([[5, 0], [5, 1], [5, 2], [5, 8], [5, 9], [5, 10]])
    # visualize_robotposition(robot_position, agent_goal, map_size, obstacle)
    # print('robot_position:', len(robot_position))